...
def plot_prediction_latency(df):
    ...
    ax.plot(df['timestamp'], df['prediction_latency_ms'], marker='o', linestyle='-', markersize=3)
...
def calculate_metrics(df):
    ...
    # precision
    true_positives = ((df_filtered['predicted'] == 1) & (df_filtered['true_label'] == 1)).sum()
